...
using HRSystemCleanArch.Presentation.ActionFilters;
using HRSystemCleanArch.Presentation.ModelBinders;
...
namespace Presentation.Controllers
{
    [Route("api")]
    [ApiController]
    public class RootController(LinkGenerator _linkGenerator) : ControllerBase
    {
